...
Route::prefix('v1')->middleware(['auth:api'])->group(function () {
    Route::prefix('outgoing-goods')->group(function () {
        Route::get('/', [OutgoingGoodList::class, Func::DEFAULT ->value]);
        Route::get('/{outgoing_good}', [OutgoingGoodList::class, 'detail']);
        Route::post('/', [OutgoingGoodCreate::class, Func::DEFAULT ->value]);
    });
});
